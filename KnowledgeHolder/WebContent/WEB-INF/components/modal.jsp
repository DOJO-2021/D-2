...
<section class="search_modal">
    ...
    <label for="search_modal_open">
        <img src="https://img.icons8.com/bubbles/50/000000/info.png"/>
    </label>
    ...
    <div class="search_modal_popUp">
        <div class="search_modal_popUp-content col-10 offset-1">
            ...
            <hr>
            <table>
            	・本サイトは利用用途に合わせて、カテゴリ検索、キーワード検索、複合検索（カテゴリ＋キーワード）の３つの検索機能があります。<br>
            	・初期表示で全質問一覧が表示されます。<br>
            	・キーワード検索では、タイトルと質問内容から一括で検索できます。<br>
                ・右にあるカテゴリ一覧からカテゴリ選択すると上のフォームに自動入力されます。<br>
                ・並び替え機能は、登録順(降順)、登録順(昇順)、アクセス数、完了済み、未完了の５つから選択いただけます。<br>
